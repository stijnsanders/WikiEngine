...
// File generated on 6/01/2006 10:51:45 from Type Library described below.
...
// create instances of the default interface _Group25 exposed by              
// the CoClass Group. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoGroup = class
    class function Create: _Group25;
    class function CreateRemote(const MachineName: string): _Group25;
  end;

// *********************************************************************//
// The Class CoUser provides a Create and CreateRemote method to          
// create instances of the default interface _User25 exposed by              
// the CoClass User. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoUser = class
    class function Create: _User25;
    class function CreateRemote(const MachineName: string): _User25;
  end;
...
class function CoGroup.Create: _Group25;
begin
  Result := CreateComObject(CLASS_Group) as _Group25;
end;

class function CoGroup.CreateRemote(const MachineName: string): _Group25;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Group) as _Group25;
end;

class function CoUser.Create: _User25;
begin
  Result := CreateComObject(CLASS_User) as _User25;
end;

class function CoUser.CreateRemote(const MachineName: string): _User25;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_User) as _User25;
end;
